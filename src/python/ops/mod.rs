...
use crate::python::files::{collect_python_files, FileError};
use crate::session::Session;
use crate::workspace::{Language, SnapshotConfig, WorkspaceSnapshot};

// Re-export common types for operations
pub use crate::output::Location;
pub use crate::python::verification::{VerificationMode, VerificationResult};
...
impl PythonOpContext {
    ...
    pub fn collect_files_from_snapshot(
        ...
        crate::python::files::collect_files_from_snapshot(&self.workspace_root, snapshot)
    }

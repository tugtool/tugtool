...
use crate::facts::{FactsStore, File as FactsFile, Symbol as FactsSymbol};
...
pub fn symbol_to_info(
    ...
    file: &FactsFile,
    content: &str,
) -> crate::output::SymbolInfo {
    let (line, col) = crate::text::byte_offset_to_position_str(content, symbol.decl_span.start);
    crate::output::SymbolInfo::from_facts(

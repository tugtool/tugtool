---
name: vet
description: Retired — use /tugplug:review-plan, which applies the same criteria and also fixes what it finds
...
`/tugplug:devise` now asks for that review itself, so in the normal flow nobody types either command.

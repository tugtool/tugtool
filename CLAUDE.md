...
The script is `tugdeck/scripts/generate-tug-tokens.ts`. The generated block is bounded by `@generated:tokens:begin` / `@generated:tokens:end` markers inside the `body {}` block. Non-token declarations (`zoom`, `--chart-*`, `--syntax-*`) live outside the markers.

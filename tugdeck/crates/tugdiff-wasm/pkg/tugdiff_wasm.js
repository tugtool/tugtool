/* @ts-self-types="./tugdiff_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function parse_unified_diff(text) {
 ...
 * @returns {any}
 */
export function two_text_diff(before, after) {
    ...
    const ret = wasm.two_text_diff(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tugdiff_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

 ...
 * All visual states driven by --tug-toggle-track-* and --tug-element-checkmark-icon-normal-plain-rest
 ...
 * [D05] Component token naming: --tug-toggle-*, --tug-element-checkmark-icon-normal-plain-rest
 */

  ...
  return (
    <div className="cg-content" data-testid="gallery-default-button">
      <div className="cg-section">
        ...
        <TugLabel size="2xs" emphasis="muted">Click outside the buttons, then press Enter to activate the default button.</TugLabel>
        ...
        {lastAction !== null && (
          <TugLabel size="2xs" emphasis="muted" data-testid="gallery-default-button-status">{lastAction}</TugLabel>
        )}
      </div>
    </div>
  );

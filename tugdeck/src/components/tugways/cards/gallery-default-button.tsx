  ...
  return (
    <div className="cg-content" data-testid="gallery-default-button">
      <div className="cg-section">
        ...
        <TugLabel size="2xs" emphasis="calm">Click outside the buttons, then press Enter to activate the default button.</TugLabel>
        ...
        {lastAction !== null && (
          <TugLabel size="2xs" emphasis="calm" data-testid="gallery-default-button-status">{lastAction}</TugLabel>
        )}
      </div>
    </div>
  );

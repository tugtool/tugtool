/**
 * gallery-tide-thinking.tsx — visual fixture for `TideThinkingBlock`.
 *
 * `TideThinkingBlock` ([chrome/tide-thinking-block.tsx]) has two
 ...
 *
 * @module components/tugways/cards/gallery-tide-thinking
 */

import "./gallery-tide-thinking.css";
...
export function GalleryTideThinking(): React.ReactElement {
  return (
    <div className="cg-content" data-testid="gallery-tide-thinking">
      <div className="cg-section gallery-tide-thinking-section">

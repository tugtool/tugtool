 ...
 * one level deeper. `depth` arrives on `ToolWrapperProps` and is
 ...
 * module and calls `registerToolWrapper("agent", TaskToolBlock)` from
 ...
 *
 * @module components/tugways/cards/tool-wrappers/task-tool-block
 */
...
export const TaskToolBlock: React.FC<ToolWrapperProps> = ({
  toolUseId,
  toolName,
  msgId,
  input,

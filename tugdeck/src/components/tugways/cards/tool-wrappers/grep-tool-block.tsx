 ...
 * module and calls `registerToolWrapper("grep", GrepToolBlock)` from
 ...
 *
 * @module components/tugways/cards/tool-wrappers/grep-tool-block
 */
...
export const GrepToolBlock: React.FC<ToolWrapperProps> = ({
  toolUseId,
  toolName,
  input,
  structuredResult,

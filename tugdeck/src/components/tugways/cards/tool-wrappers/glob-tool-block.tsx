 ...
 * module and calls `registerToolWrapper("glob", GlobToolBlock)` from
 ...
 *
 * @module components/tugways/cards/tool-wrappers/glob-tool-block
 */
...
export const GlobToolBlock: React.FC<ToolWrapperProps> = ({
  toolUseId,
  toolName,
  input,
  structuredResult,

 ...
 *
 * Composes `ToolWrapperChrome` (header / status / error band) around a
 ...
 *   `registerToolWrapper("edit", EditToolBlock)` from its own
 ...
 *
 * @module components/tugways/cards/tool-wrappers/edit-tool-block
 */
...
export const EditToolBlock: React.FC<ToolWrapperProps> = ({
  toolUseId,
  toolName,
  input,
  structuredResult,

/**
 * tide-jump-to-bottom-button.tsx — round "scroll to latest" affordance
 * for the tide-card transcript.
 *
 ...
 *
 * @module components/tugways/cards/tide-jump-to-bottom-button
 */

import "./tide-jump-to-bottom-button.css";
...
>(function TideJumpToBottomButton({ onClick }, ref) {
  return (
    <TugPushButton
      ref={ref}
      data-slot="tide-jump-to-bottom-button"
      className="tide-jump-to-bottom-button"
      subtype="icon"
      emphasis="filled"
      role="action"
      size="sm"

  ...
  return (
    ...
    >
      ...
      <div className="cg-section" data-testid="observable-props-inspector">
        ...
        <TugLabel size="2xs" color="muted">Each control dispatches setProperty via sendToTarget(cardId, ...). The action routes through the parent Tugcard's responder node to the registered PropertyStore. Source is tagged 'inspector' to prevent circular loops.</TugLabel>

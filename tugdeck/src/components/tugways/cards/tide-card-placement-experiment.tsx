 ...
 *    renderer components themselves (in `tide-card-telemetry-renderers`)
 *    own all DOM. No appearance state in React beyond the slot node
 *    identity.
 *
 * @module components/tugways/cards/tide-card-placement-experiment
 */
...
function writePlacement(next: PlacementMap): void {
  ...
  fetch(
    ...
    console.warn(`[tide-placement-experiment] PUT failed:`, err);
  });
}

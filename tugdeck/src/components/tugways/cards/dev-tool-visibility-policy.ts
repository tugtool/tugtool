 ...
 * in `dev-assistant-renderer-dispatch.ts`:
 *
 ...
 *  - Run `bun test dev-tool-visibility-policy.test.ts` — the governance
 ...
 *
 * # Invariants (enforced by `dev-tool-visibility-policy.test.ts`)
 *
 ...
 * project policy in `roadmap/dev-assistant-rendering.md` (the MCP
 ...
 *
 * @module components/tugways/cards/dev-tool-visibility-policy
 */

/**
 * tide-attachment-preview.tsx — pane-sheet attachment preview body.
 *
 ...
 *  - [L19] file pair (`tide-attachment-preview.tsx` +
 *    `tide-attachment-preview.css`), module docstring, exported
 *    props interface, `data-slot="tide-attachment-preview"`.
 *
 * @module components/tugways/cards/tide-attachment-preview
 */

import "./tide-attachment-preview.css";
...
export function TideAttachmentPreview({
  ...
  return (
    <div
      data-slot="tide-attachment-preview"
      className="tide-attachment-preview"
    >
      <div
        data-slot="tide-attachment-preview__image-area"
        className="tide-attachment-preview__image-area"
      >
        {dataUrl !== null ? (
          <img
            data-slot="tide-attachment-preview__image"
            className="tide-attachment-preview__image"
            src={dataUrl}
            alt={atom.label}
          />
        ) : (
          <div
            data-slot="tide-attachment-preview__empty"
            className="tide-attachment-preview__empty"
            aria-hidden="true"
          />
        )}
      </div>

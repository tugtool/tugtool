  ...
  return (
    <div className="cg-content" data-testid="gallery-mutation-tx">
      ...
      <div className="cg-section">
        ...
        <TugLabel size="2xs" emphasis="muted">A positioned div whose CSS properties are mutated by the demos below. Commit keeps the final value; cancel restores the original.</TugLabel>
      ...
      <div className="cg-section">
        ...
        <TugLabel size="2xs" emphasis="muted">Updated via direct DOM writes during gestures — no React re-renders.</TugLabel>
      ...
      <div className="cg-section" data-testid="demo-color-input">
        ...
        <TugLabel size="2xs" emphasis="muted">The color picker dispatches begin on first input, change on subsequent inputs (intermediate picks), and commit on the change event (dialog closed). Cancel restores the original color.</TugLabel>
        <div className="cg-mutation-tx-controls">
          ...
          />
          <TugLabel size="2xs" emphasis="muted">Pick a color to preview on the mock card</TugLabel>
        </div>
      </div>
      ...
      <div className="cg-section" data-testid="demo-hue-scrub">
        ...
        <TugLabel size="2xs" emphasis="muted">Drag horizontally across the swatch to scrub the hue of the mock card's background-color. Release to commit; press Escape to cancel and restore the original color.</TugLabel>
        <div className="cg-mutation-tx-controls">
          <div
          ...
          />
          <TugLabel size="2xs" emphasis="muted">Drag to scrub hue · Esc to cancel</TugLabel>
        </div>
      </div>
      ...
      <div className="cg-section" data-testid="demo-position-sliders">
        ...
        <TugLabel size="2xs" emphasis="muted">Two range sliders set the left and top inline styles of the mock card, demonstrating multi-property snapshotting. The transaction begins on pointerdown and commits on pointerup.</TugLabel>
        <div className="cg-mutation-tx-slider-group">
          <TugLabel size="2xs" emphasis="muted" htmlFor="slider-x">X (left)</TugLabel>
          <input
            ref={sliderXRef}
            id="slider-x"
            type="range"
        ...
        <div className="cg-mutation-tx-slider-group">
          <TugLabel size="2xs" emphasis="muted" htmlFor="slider-y">Y (top)</TugLabel>
          <input
            ref={sliderYRef}
            id="slider-y"
            type="range"

/**
 * gallery-tide-chrome.tsx — visual fixture for the per-card chrome
 ...
 *   - version_drift
 *
 * @module components/tugways/cards/gallery-tide-chrome
 */
...
export function GalleryTideChrome(): React.ReactElement {
  return (
    <div className="cg-content" data-testid="gallery-tide-chrome">

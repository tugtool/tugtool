/**
 * `BlockFieldRow` — a `<label>: <value>` row inside a tool-block
 ...
 *  - [L20] owns only `--tugx-block-field-row-*` slots (none
...
export type BlockFieldRowLayout = "inline" | "stacked";

export interface BlockFieldRowProps {
  /**
   ...
   * @default "inline"
   */
  layout?: BlockFieldRowLayout;
  /** Forwarded class name for cascade-scoped customization. */
  className?: string;
}

export const BlockFieldRow: React.FC<BlockFieldRowProps> = ({
  label,
  children,
  layout = "inline",
  className,

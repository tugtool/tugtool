 ...
 * `BlockChrome` around an `embedded` `FileBlock` whose `FileData`
 ...
 *    `rootSlot`).
 *  - [L20] reuses the chrome's `--tugx-block-*` and `FileBlock`'s
 ...
 *    same commit.
 *
 * @module components/tugways/cards/blocks/write-tool-block
 */

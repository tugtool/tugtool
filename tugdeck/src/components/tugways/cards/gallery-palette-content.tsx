...
const DEFAULT_CANONICAL_L: Record<string, number> = {
  cherry: 0.77, red: 0.79, tomato: 0.80, flame: 0.85, orange: 0.87,
  amber: 0.89, gold: 0.90, yellow: 0.94, lime: 0.91, green: 0.84,
  mint: 0.86, teal: 0.88, cyan: 0.87, sky: 0.90, blue: 0.86,
  indigo: 0.88, violet: 0.89, purple: 0.88, plum: 0.88, pink: 0.90,
  rose: 0.91, magenta: 0.92, crimson: 0.90, coral: 0.90,
};

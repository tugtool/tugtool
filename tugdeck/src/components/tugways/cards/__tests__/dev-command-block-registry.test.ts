/**
 * Governance test for `dev-command-block-registry.ts` — pins the
 ...
 *
 * @module components/tugways/cards/__tests__/dev-command-block-registry
 */
...
import {
  ...
  resolveCommandBlock,
} from "../dev-command-block-registry";
import type { CommandBlockRenderer } from "../dev-command-block-registry";
...
describe("dev-command-block-registry", () => {

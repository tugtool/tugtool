/**
 * Governance test for `dev-tool-visibility-policy.ts` — pins the two
 ...
 *
 * @module components/tugways/cards/__tests__/dev-tool-visibility-policy
 */
 ...
 * (`roadmap/dev-assistant-rendering.md` §Open Questions). It is not
 * listed here.
 */
 ...
 * Mirrors `TOOL_ALIASES` in `dev-assistant-renderer-dispatch.ts`.

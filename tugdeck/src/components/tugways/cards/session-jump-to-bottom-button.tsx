/**
 * session-jump-to-bottom-button.tsx — round "scroll to latest" affordance
 * for the session-card transcript.
 *
 ...
 *
 * @module components/tugways/cards/session-jump-to-bottom-button
 */

import "./session-jump-to-bottom-button.css";
...
export interface SessionJumpToBottomButtonProps {
  /**
 ...
 */
export const SessionJumpToBottomButton = React.forwardRef<
  HTMLButtonElement,
  SessionJumpToBottomButtonProps
>(function SessionJumpToBottomButton({ onClick }, ref) {
  return (
    <TugPushButton
      ref={ref}
      data-slot="session-jump-to-bottom-button"
      className="session-jump-to-bottom-button"
      subtype="icon"
      emphasis="filled"
      role="action"
      size="sm"

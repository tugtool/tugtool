 ...
 *
 * @module components/tugways/cards/dev-card-telemetry-renderers
 */
...
export const DevTelemetryWindowUtilization: React.FC<DevTelemetryProps> = ({
  ...
  // CSS (see dev-card.css under `.dev-card-status-bar`) drops the
  ...
  return (
    <TugArcGauge
      className="dev-telemetry-window-utilization"
      data-slot="dev-telemetry-window-utilization"
      value={contextTokens}
      min={0}
      max={max}
      density="compact"
...
export const DevTelemetryCumulativeTokens: React.FC<DevTelemetryProps> = ({
  ...
  return (
    <span
      ...
      data-slot="dev-telemetry-cumulative-tokens"
    >
...
export const DevTelemetryCumulativeActiveMs: React.FC<DevTelemetryProps> = ({
  ...
  return (
    <span
      className="dev-telemetry-text"
      data-slot="dev-telemetry-cumulative-active-ms"
    >
...
export const DevTelemetryPhase: React.FC<DevTelemetryProps> = ({
  ...
  return (
    <span className="dev-telemetry-text" data-slot="dev-telemetry-phase">
      {phase}
    </span>
  );
};
...
export const DevTelemetryPerTurnCost: React.FC<DevTurnTelemetryProps> = ({
  ...
  <span
    className="dev-telemetry-text"
    data-slot="dev-telemetry-per-turn-cost"
  >
...
export const DevTelemetryPerTurnTtft: React.FC<DevTurnTelemetryProps> = ({
  ...
  <span
    className="dev-telemetry-text"
    data-slot="dev-telemetry-per-turn-ttft"
  >

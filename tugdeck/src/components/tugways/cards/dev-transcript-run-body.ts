/**
 * dev-transcript-run-body.ts — classify an assistant run's message
 ...
 * Messages (see `dev-transcript-data-source.ts`). Some runs paint no
 ...
 *
 * @module components/tugways/cards/dev-transcript-run-body
 */

import type { Message } from "@/lib/code-session-store";

import { resolveToolBlock, NullToolBlock } from "./dev-assistant-renderer-dispatch";

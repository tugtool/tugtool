  ...
  return (
    <div className="cg-content" data-testid="gallery-skeleton">
      ...
      <div className="cg-section">
        ...
        <TugLabel size="2xs" emphasis="calm">TugSkeletonGroup wraps skeletons in a flex column with configurable gap. This group mimics a paragraph of loading text.</TugLabel>
      ...
      <div className="cg-section">
        ...
        <TugLabel size="2xs" emphasis="calm">All skeleton elements share the same CSS pulse animation, so elements across separate groups breathe in sync.</TugLabel>

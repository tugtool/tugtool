 ...
 * module and calls `registerToolBlock("todowrite", TodoWriteToolBlock)`
 ...
 *
 * @module components/tugways/cards/tool-blocks/todo-write-tool-block
 */
...
export const TodoWriteToolBlock: React.FC<ToolBlockProps> = ({
  toolName,
  input,
  textOutput,
  status,

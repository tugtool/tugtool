/**
 * `ToolBlockNoticeBand` — the thin, collapse-independent annotation band a
 ...
 * tone icon, rendered by `ToolBlockChrome` in BOTH the collapsed and expanded
 ...
 *    colors for the icon.
 *
 * @module components/tugways/cards/tool-blocks/tool-block-notice
 */

import "./tool-block-notice.css";
...
export type ToolBlockNoticeTone = "error" | "warning" | "info" | "success";
 ...
 */
export interface ToolBlockNotice {
  tone: ToolBlockNoticeTone;
...
const DEFAULT_ICON: Readonly<Record<ToolBlockNoticeTone, React.ReactNode>> = {
...
/**
 * Render a {@link ToolBlockNotice}. The chrome mounts this between the header
 * and the body in both collapse states.
 */
export const ToolBlockNoticeBand: React.FC<
  ToolBlockNotice & { className?: string }

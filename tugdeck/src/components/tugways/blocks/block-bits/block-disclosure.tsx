 ...
 * Composition:
 *
 *     <BlockDisclosure summary="show 4 earlier lines">
 ...
 *  - [L20] no `--tugx-block-disclosure-*` tokens — typography
...
export interface BlockDisclosureProps {
  /**
...
export const BlockDisclosure: React.FC<BlockDisclosureProps> = ({
  summary,
  children,
  defaultOpen = false,
  className,

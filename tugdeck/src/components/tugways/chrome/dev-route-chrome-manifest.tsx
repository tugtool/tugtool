 ...
 *
 *  - **[L26] identity badge never unmounts.** It is always the first child at
 *    the same position, so React reconciles it as the same mount; the badge's
 *    own `isShell` branch swaps its face (btw shares the code face per T01).

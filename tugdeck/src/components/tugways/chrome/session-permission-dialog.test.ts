/**
 * Pure-logic tests for `session-permission-dialog.tsx`.
 *
...
} from "./session-permission-dialog";
import {
  KIND_RENDERERS,
  dispatch,
...
import { hasBespokeWrapper } from "@/components/tugways/cards/session-assistant-renderer-registrations";

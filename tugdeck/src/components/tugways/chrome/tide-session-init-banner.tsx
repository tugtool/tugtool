 ...
 *    `data-slot="tide-session-init-banner"`, this docstring.
 ...
 *    `caution` prop.
 *
 * @module components/tugways/chrome/tide-session-init-banner
 */

import "./tide-session-init-banner.css";
...
export const TideSessionInitBanner: React.FC<TideSessionInitBannerProps> = ({
  ...
  return (
    <div
      data-slot="tide-session-init-banner"
      className="tide-session-init-banner"
    >
      <Cpu size={14} aria-hidden="true" className="tide-session-init-banner-icon" />
      {current.model !== undefined ? (
        <span
          className="tide-session-init-banner-field"
          data-slot="tide-session-init-banner-model"
        >
          <span className="tide-session-init-banner-field-label">model</span>
          <code className="tide-session-init-banner-field-value">
            {current.model}
          </code>
        </span>
      ) : null}
      {current.permissionMode !== undefined ? (
        <span
          className="tide-session-init-banner-field"
          data-slot="tide-session-init-banner-permission-mode"
        >
          <span className="tide-session-init-banner-field-label">
            permission
          </span>
          <code className="tide-session-init-banner-field-value">
      ...
      {current.cwd !== undefined ? (
        <span
          className="tide-session-init-banner-field"
          data-slot="tide-session-init-banner-cwd"
        >
          <span className="tide-session-init-banner-field-label">cwd</span>
          <code className="tide-session-init-banner-field-value">
            {current.cwd}
          </code>
        </span>

...
const ATOM_ICON_PATHS: Record<string, string> = {
  file: '<path d="AT0015 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="AT0014 2v4a2 2 0 0 0 2 2h4"/><path d="AT0010 9H8"/><path d="AT0016 13H8"/><path d="AT0016 17H8"/>',
  ...
  link: '<path d="AT0010 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="AT0014 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/>',
};

...
//
// Light-mode pair exceptions for the brio-light synthetic variant (T4.2).
// The engine is calibrated for dark mode; these surfaces derive too dark
// in light mode, creating structural contrast constraints.
// ---------------------------------------------------------------------------

/**
 * Light-mode pair exceptions for brio-light (synthetic mode-flip variant, T4.2).
 * The engine is calibrated for dark mode; light-mode surface derivation creates
 * structural constraints not present in dark mode.
 */
export const LIGHT_MODE_PAIR_EXCEPTIONS: ReadonlySet<string> = new Set([
  "--tug-base-fg-default|--tug-base-bg-app", // [phase-3-bug] bg-app derives too dark in light mode; structural engine calibration gap; Phase 3 will address
  "--tug-base-fg-default|--tug-base-bg-canvas", // [phase-3-bug] bg-canvas same structural constraint as bg-app in light mode
  "--tug-base-fg-default|--tug-base-surface-raised", // [phase-3-bug] surface-raised derives too dark in light mode; same calibration gap
  "--tug-base-fg-default|--tug-base-surface-overlay", // [phase-3-bug] surface-overlay near-miss in light mode; structural constraint
  "--tug-base-fg-default|--tug-base-surface-sunken", // [phase-3-bug] surface-sunken near-miss in light mode; structural constraint
  "--tug-base-fg-default|--tug-base-surface-screen", // [phase-3-bug] surface-screen derives too dark in light mode; structural calibration gap
  "--tug-base-fg-inverse|--tug-base-surface-screen", // [design-choice] fg-inverse is for on-fill text (dark bg); polarity mismatch on light surface
]);

// ---------------------------------------------------------------------------
// LIGHT_MODE_BODY_TEXT_PAIR_EXCEPTIONS
//
// Light-mode pair exceptions for stress tests (T4.4, T4.7).
// Superset of LIGHT_MODE_PAIR_EXCEPTIONS, includes additional pairs surfaced
// by the stress test recipes.
// ---------------------------------------------------------------------------

/**
 * Light-mode body-text pair exceptions for stress test recipes (T4.4, T4.7).
 * These are the same structural surface-derivation constraints as LIGHT_MODE_PAIR_EXCEPTIONS,
 * plus step-5 gap pairs that may appear in light-mode stress scenarios.
 */
export const LIGHT_MODE_BODY_TEXT_PAIR_EXCEPTIONS: ReadonlySet<string> = new Set([
  "--tug-base-fg-default|--tug-base-bg-app", // [phase-3-bug] bg-app derives too dark in light mode; Phase 3 will address
  "--tug-base-fg-default|--tug-base-bg-canvas", // [phase-3-bug] bg-canvas same structural constraint as bg-app in light mode
  "--tug-base-fg-default|--tug-base-surface-raised", // [phase-3-bug] surface-raised derives too dark in light mode
  "--tug-base-fg-default|--tug-base-surface-overlay", // [phase-3-bug] surface-overlay near-miss in light mode
  "--tug-base-fg-default|--tug-base-surface-sunken", // [phase-3-bug] surface-sunken near-miss in light mode
  "--tug-base-fg-default|--tug-base-surface-screen", // [phase-3-bug] surface-screen derives too dark in light mode
  "--tug-base-fg-inverse|--tug-base-surface-screen", // [design-choice] fg-inverse is for on-fill text; polarity mismatch on light surface
  // Step 5 gap pairs also appear in light-mode stress tests
  "--tug-base-fg-default|--tug-base-tab-bg-active", // [phase-3-bug] card title text on active title bar; same gap as dark mode
  "--tug-base-fg-default|--tug-base-accent-subtle", // [phase-3-bug] menu selected item text on 15%-alpha tint; same gap as dark mode
  "--tug-base-fg-default|--tug-base-tone-caution-bg", // [phase-3-bug] autofix suggestion text on caution tint; same gap as dark mode
]);

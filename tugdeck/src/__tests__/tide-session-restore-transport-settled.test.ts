/**
 * `tide-session-restore` — transport_settled wiring on binding arrival
 * (Step 5 of tugplan-tide-connection-health).
 *
...
describe("tide-session-restore — transport_settled on binding arrival (Step 5)", () => {
  it("clears the registry entry and dispatches transport_settled into the store", () => {
    const cardId = "tide-restore-card-1";
  ...
  it("a binding-arrival without a registry entry does not dispatch transport_settled", () => {
    ...
    const cardId = "tide-restore-card-2";

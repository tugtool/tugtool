...
describe("Gallery tab 'Observable Props' is the eighth tab (of twenty-two total)", () => {
  it("GALLERY_DEFAULT_TABS has exactly twenty-two entries", () => {
    expect(GALLERY_DEFAULT_TABS).toHaveLength(22);
  });

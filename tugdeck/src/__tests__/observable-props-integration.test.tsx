...
describe("Gallery tab 'Observable Props' is the eighth tab (of thirteen total)", () => {
  it("GALLERY_DEFAULT_TABS has exactly thirteen entries", () => {
    expect(GALLERY_DEFAULT_TABS).toHaveLength(13);
  });

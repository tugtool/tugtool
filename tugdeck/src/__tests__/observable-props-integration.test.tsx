...
describe("Gallery tab 'Observable Props' is the eighth tab (of fifteen total)", () => {
  it("GALLERY_DEFAULT_TABS has exactly fifteen entries", () => {
    expect(GALLERY_DEFAULT_TABS).toHaveLength(15);
  });

...
describe("Gallery tab 'Observable Props' is the eighth tab (of fourteen total)", () => {
  it("GALLERY_DEFAULT_TABS has exactly fourteen entries", () => {
    expect(GALLERY_DEFAULT_TABS).toHaveLength(14);
  });

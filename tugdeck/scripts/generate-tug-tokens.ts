 ...
 *
 * Generates ALL --tug-base-* tokens in styles/tug-base.css from the
...
lines.push(
  `  /* @generated:tokens:begin \u2014 do not edit. Source: theme-derivation-engine.ts */`,
);
lines.push(
...
const BEGIN_MARKER = "/* @generated:tokens:begin";
...
if (beginIdx === -1 || endIdx === -1) {
  console.error(
    `[generate-tug-tokens] ERROR: marker comments not found in ${cssPath}`,
  );
...
console.log(
  `[generate-tug-tokens] wrote ${tokenCount} tokens to ${cssPath}`,
);

...
lines.push(` *   2. tug.css         — entry point (fonts, multipliers, scrollbars)`);
lines.push(` *   3. theme/*.css     — theme tokens (can override per-hue constants)`);
lines.push(` *`);
lines.push(` * All variables are scoped to \`body\` to match tug.css cascade scope.`);

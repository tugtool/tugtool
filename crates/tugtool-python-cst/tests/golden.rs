...
//! Golden file tests for tugtool-python-cst visitor analysis.
//!
...
//!
//! ```bash
//! cargo nextest run -p tugtool-python-cst golden
//! ```
//!
...
//! ```bash
//! TUG_UPDATE_GOLDEN=1 cargo nextest run -p tugtool-python-cst golden

 ...
 * session-card uses internally). Runs the full P1→P2 drag round-trip.
...
describe.skipIf(!SHOULD_RUN)("at0006-em: EM cross-pane drag preserves engine state + restores focus", () => {
  test("gallery-prompt-entry (TugPromptEntry, session-card's editor): drag A from P1 to P2's tab bar", async () => {

/**
 * at0035-em-app-switch-selection.test.ts — selection survives the
 * app-resign / app-become-active round-trip (cmd-tab away + back)
 * for EM cards.
 *
 * ## Why this exists
 *
 * User-reported: type "hello" in a session-card's TugPromptEntry,
 ...
 * ## Coverage
 *
 * `gallery-prompt-entry` (TugPromptEntry, what session-card uses

 ...
 *
 * Coverage: `gallery-prompt-entry` (TugPromptEntry, what session-card
...
describe.skipIf(!SHOULD_RUN)("at0007-em: EM card detach to new standalone pane preserves engine state + dispatches onCardActivated", () => {
  test("gallery-prompt-entry (TugPromptEntry, session-card's editor): drag A out of P1 to canvas void", async () => {

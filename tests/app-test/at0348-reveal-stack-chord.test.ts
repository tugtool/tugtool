 ...
 *
 * Notably there is no deselected-deck escape hatch here, unlike the lateral
 * pair beside it in the Window menu (`Previous Card` and `Next Card` stay
 * live on a deselected deck so the keyboard can

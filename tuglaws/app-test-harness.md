...
| Gate port (`APPTEST_GATE_PORT`, 55600) | `tug host gate` holder | `TcpListener::bind` at invocation start | OS on process exit — including SIGKILL (`FD_CLOEXEC` keeps gated children from inheriting it) | None — bounded to process |

...
- HVV palette `var()` wiring (tokens remain literal hex; HVV wiring is a separate future phase)
...
- Phase 5d5a (HVV Palette Engine): COMPLETE -- HVV palette available but not consumed in this phase
...
- [ ] Wire `--tug-base-*` color tokens to HVV palette `var()` references (Phase 5d5e or later)

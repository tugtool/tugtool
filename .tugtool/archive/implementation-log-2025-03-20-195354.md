...
## step-4: Migrated EXAMPLE_RECIPES to parameters, removed MoodSlider call sites and dead function definition from gallery component. Updated runDerive(), handleSliderChange(), useEffect, currentRecipe, loadPreset(), handleRecipeImported() to drop surfaceContrast/signalIntensity/warmth params. DARK_FORMULAS/LIGHT_FORMULAS retained as exported test fixtures.
...
bun test v1.3.9 (cf6cdbbb)
 1879 pass
 0 fail
Ran 1879 tests across 73 files.
exit code: 0
```

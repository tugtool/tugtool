...
## step-1: Rewrote tug-palette.css: removed 13 coefficient variables, replaced 7-preset formula blocks with 5-preset calc()+clamp() using literal i/t numbers, renamed accent to intense, removed subtle/deep, updated neutral ramp to 5 presets per Table T02
